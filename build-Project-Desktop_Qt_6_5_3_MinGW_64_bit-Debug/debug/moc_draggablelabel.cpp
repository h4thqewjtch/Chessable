...
#include "../../Project/DraggableLabel/draggablelabel.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSDraggableLabelENDCLASS_t qt_meta_stringdata_CLASSDraggableLabelENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(15, 10),  // "move_label"
        QT_MOC_LITERAL(26, 0)   // ""
    },
    "DraggableLabel",
    "move_label",
...
void DraggableLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DraggableLabel *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->move_label((*reinterpret_cast< std::add_pointer_t<QPoint>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DraggableLabel::*)(const QPoint & );
            if (_t _q_method = &DraggableLabel::move_label; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DraggableLabel::move_label(const QPoint & _t1)
{
